Pod::Spec.new do |s|
  ...
  s.source_files = 'gh-unit/Classes/**/*.{h,m}', 'gh-unit/Libraries/GTM/**/*.{h,m}'
  s.ios.source_files = 'gh-unit/Classes-iOS/**/*.{h,m}'
  s.osx.source_files = 'gh-unit/Classes-MacOSX/UI/*.{h,m}'
  s.osx.resources = 'gh-unit/Classes-MacOSX/UI/*.xib'
